...
This fork adds a local web console and China-market data fallbacks for A-share research.

## What changed

- Local web dashboard under `web/`, with a Windows launcher: `start_tradingagents_web.cmd`.
- A-share market data through East Money, with Alpha Vantage and yfinance fallback.
- A-share sentiment and company news through East Money Guba.
